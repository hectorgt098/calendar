...
<form method="POST" action="">
        ...
        <a href="eventos.php">Ir al calendario comun</a>
</form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formGroup" id="TituloHoraInicio">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" id="ubicacion" class="form-control" placeholder="Por favor pega el enlace de google maps" style="height:36px;">
                    </div>

                    <div class="form-row">
                        <label>Selecciona una imagen</label>
                        <input type="file" id="imagen" accept="image/png, image/jpg, image/webp">
                    </div>
                </div>
    ...
    <script>
        ...
        let calendario1 = new FullCalendar.Calendar(document.getElementById('calendario1'),{
            ...
            eventClick: function(info){
                ...
                $('#ubicacion').val(info.event.extendedProps.ubication);
                $('#lugar').val(info.event.extendedProps.location);
                $("#FormularioEventos").modal('show');
            },
        ...
        function recuperarDatosFormulario(){
            ...
            formData.append("inicio", registro.inicio);
            formData.append("fin", registro.fin);
            formData.append("colorfondo", registro.colorfondo);
            formData.append("colorTexto", registro.colorTexto);
            formData.append("ubicacion", registro.ubicacion);
